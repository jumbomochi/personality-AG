import { ScoringModel, ResponseMap, calculateFactorScores } from '../core';
...
export const mbtiModel: ScoringModel = {
  name: 'MBTI',
  factors: [
    {
      id: 'E_I',
 ...
 */
export function calculateMbtiType(responses: ResponseMap): string {
  const scores = calculateFactorScores(responses, mbtiModel);
  let type = '';
