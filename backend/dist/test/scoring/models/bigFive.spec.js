...
const bigFive_1 = require("../../../src/scoring/models/bigFive");
...
describe('Big Five Scoring Logic', () => {
    it('should accurately calculate Extraversion and Agreeableness', () => {
        ...
        const responses = {
            ...Object.fromEntries(bigFive_1.bigFiveModel.factors.flatMap((f) => f.positiveItems.map((id) => [id, 3]))),
            ...Object.fromEntries(bigFive_1.bigFiveModel.factors.flatMap((f) => f.negativeItems.map((id) => [id, 3]))),
        ...
        const results = (0, core_1.calculateFactorScores)(responses, bigFive_1.bigFiveModel);
        const ext = results['E'];
        const agr = results['A'];
    ...
    it('should throw error on missing response required by factor definition', () => {
        ...
        expect(() => (0, core_1.calculateFactorScores)(responses, bigFive_1.bigFiveModel)).toThrow(/Missing response for item/);
    });
});
