import { reverseScore, calculateFactorScores, ScoringModel } from '../../src/scoring/core';
import { score16pf } from '../../src/scoring/models/16pf';
...
describe('Core Scoring Logic', () => {
  ...
  describe('calculateFactorScores', () => {
    ...
    it('should correctly sum raw scores and averages', () => {
      ...
      const result = calculateFactorScores(responses, mockModel);
    ...
    it('should throw error if a required response is missing', () => {
      ...
      expect(() => calculateFactorScores(responses, mockModel)).toThrow(/Missing response/);
    });
  });
  ...
  describe('16pf STEN Conversion', () => {
    it('should correctly apply STEN conversions', () => {
      ...
      const results = score16pf(responses);
